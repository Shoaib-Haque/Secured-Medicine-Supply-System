		...
		{{csrf_field()}}
			...
			@endif
				...
				<table onmouseover="hide(tooltip1)" style="width: 90%">
					<tr>
						<td>
							<font color="blue">Net Amount:</font><input style="border:none;background-color: #f2f2f2; width: 200px" value="0.00Tk" name="total" readonly="readonly" type="text" id="total" onmouseover="hide(tooltip1)">
						</td>
					</tr>
					<tr>
						<td>
